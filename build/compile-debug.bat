...
pushd
call del ..\dist\build_debug_output.txt
...
@echo on
REM call java -jar ..\closure\compiler.jar --warning_level=VERBOSE --js %EFW_FILES% --externs %EFW_EXTERNS% --js_output_file .\..\dist\efw.min.js 2>.\..\dist\build_debug_output.txt
